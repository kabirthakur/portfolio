import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Provided one-on-one and small-group tutoring to student-athletes across undergraduate coursework in Physics, Mathematics, Probability and Statistics, and Calculus, strengthening conceptual understanding, quantitative reasoning, and academic performance.",
      ],
    },
    {
      id: "work-abacus-ade",
      title: "Associate Data Engineer",
      company_name: "Abacus Insights",
      icon: datae,
      iconBg: "#232631",
      date: "Jul 2024 – Sep 2025",
      points: [
        "Built foundational healthcare data pipelines and transformation workflows, converting raw source files into reliable, analysis-ready datasets.",
        "Contributed to Spark, PySpark, and SQL-based engineering workflows across Databricks and cloud data platforms, with a focus on quality and maintainability.",
      ],
    },
    {
      id: "work-abacus-de",
      ...
      points: [
        "Scaled production data workflows using Spark, PySpark, SQL, Delta Lake, AWS, and Snowflake to improve pipeline reliability and delivery speed.",
        "Improved observability and data quality practices across core jobs, helping reduce operational friction for downstream analytics teams.",
      ],
    },
    {
      id: "work-abacus-sde",
      ...
      points: [
        "Lead architecture and execution for healthcare data engineering initiatives, aligning platform decisions with analytics and business requirements.",
        "Develop agentic orchestration patterns that automate validation, strengthen monitoring, and improve trust in production data systems.",
      ],
    },
  ];
